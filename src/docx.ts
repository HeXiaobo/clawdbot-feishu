    ...
    api.registerTool(
      {
        ...
        label: "Feishu Doc",
        description:
          'Feishu document operations. Actions: read, write, append, create, create_and_write, delete, list_blocks, get_block, update_block, delete_block. Use "create_and_write" for atomic create + content write.',
