...
export function registerFeishuDocTools(api: OpenClawPluginApi) {
  ...
  if (docEnabled) {
    registerDocTool<FeishuDocParams>(api, {
      ...
      label: "Feishu Doc",
      description:
        'Feishu document operations. Actions: read, write, append, create, create_and_write, delete, list_blocks, get_block, update_block, delete_block, list_comments, create_comment, get_comment, list_comment_replies. Use "create_and_write" for atomic create + content write.',
